...
test_script!(get_edge_range_bad_high);
test_script!(get_edge_range_bad_limit);
test_script!(get_edge_range_bad_low);
test_script!(get_edge_range);
test_script!(get_reversed_edge_count);
test_script!(get_reversed_edge_range_bad_high);
test_script!(get_reversed_edge_range_bad_low);
test_script!(get_reversed_edge_range);
